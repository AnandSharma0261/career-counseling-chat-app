...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    if (theme === 'system') {
      ...
      console.log('System theme is:', systemTheme); // Debug log
      root.classList.add(systemTheme);
      return;
    }

    root.classList.add(theme);
    console.log('Applied theme class:', theme); // Debug log
  }, [theme, mounted]);
  ...
  if (!mounted) {
    return (
      <ThemeProviderContext.Provider value={{ theme: defaultTheme, setTheme: () => null }}>
        {children}
